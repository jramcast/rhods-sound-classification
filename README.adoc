...
// TechEditor:[style] "will" as a future tense is generally avoided. Are te two ways two different options? if yes then, "you can" could be used here.
...
// TechEditor:[style] This sentence does not make sense. I think the "and" is misplaced. If you remove the "and" then the sentence makes sense. I wasnt sure if you had more intention to introduce something here so I have lf it up to you to take a look at. 
